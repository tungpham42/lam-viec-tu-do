...
namespace Drupal\my_statistics\Plugin\Block;
...
use Drupal\my_statistics\StatisticsStorageInterface;

/**
 * Provides a 'Popular content' block.
 *
 * @Block(
 *   id = "my_statistics_popular_block",
...
class StatisticsPopularBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * The storage for my_statistics.
   *
   * @var \Drupal\my_statistics\StatisticsStorageInterface
   */
   ...
   *   The entity repository service
   * @param \Drupal\my_statistics\StatisticsStorageInterface $statistics_storage
   *   The storage for my_statistics.
   */
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $container->get('my_statistics.storage.node'),
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $form['my_statistics_block_top_day_num'] = [
     '#type' => 'select',
    ...
    $form['my_statistics_block_top_all_num'] = [
      '#type' => 'select',
    ...
    $form['my_statistics_block_top_last_num'] = [
      '#type' => 'select',
  ...
  public function blockSubmit($form, FormStateInterface $form_state) {
    $this->configuration['top_day_num'] = $form_state->getValue('my_statistics_block_top_day_num');
    $this->configuration['top_all_num'] = $form_state->getValue('my_statistics_block_top_all_num');
    $this->configuration['top_last_num'] = $form_state->getValue('my_statistics_block_top_last_num');
  }
