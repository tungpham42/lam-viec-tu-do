...
/**
 * Provides an interface defining NodeCounter Storage.
 *
 * Stores the views per day, total views and timestamp of last view
 * for entities.
 */
interface NodeCounterStorageInterface {
   ...
   *
   * @return \Drupal\nodeCounter\NodeCounterViewsResult|false
