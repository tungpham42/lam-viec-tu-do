 ...
 */
class NodeViewsStatisticsDatabaseStorage implements ViewsStatisticsStorageInterface {
  ...
  */
  ...
  public function fetchViews($ids) {
    $views = $this->connection
      ->select('node_views_counter', 'nvc')
      ->fields('nvc', ['totalcount', 'daycount', 'timestamp'])
...
//       $this->connection->update('node_views_counter')
//         ->fields(['daycount' => 0])
//         ->execute();
//     }
//   }
  ...
  public function maxTotalCount() {
    $query = $this->connection->select('node_views_counter', 'nvc');
